  ...
  return (
    <div className='sm:text-left font-[family-name:var(--font-geist-mono)] w-full'>
      <div className='mb-6'>
        ...
        <Link
          href='#articles'
          className='inline-flex items-center px-5 py-2.5 mt-2 rounded-lg border border-red-400 bg-red-400 bg-opacity-10 hover:bg-opacity-20 transition-all duration-300 shadow-sm shadow-red-900/20'
        >
          ...
          <svg
            ...
            viewBox='0 0 20 20'
            fill='currentColor'
            className='w-4 h-4 ml-2 text-red-400 group-hover:translate-x-1 transition-transform'
          >
            <path
              fillRule='evenodd'
